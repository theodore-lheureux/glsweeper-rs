...
impl GameTextures {
    pub fn new() -> Self {
        GameTextures {
            ...
            tile_revealed: vec![
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_0.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_1.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_2.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_3.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_4.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_5.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_6.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_7.png")
                        .to_vec(),
                    0,
                ),
                Texture::new(
                    include_bytes!("../../textures/tile_revealed_8.png")
                        .to_vec(),
                    0,
                ),
            ],
